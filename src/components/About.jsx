...
function About() {
  return (
    <section
      id="aboutSection"
      className="w-full md:h-[600px] h-auto bg-white px-5 sm:px-20 relative pb-16"
    >
      ...
      <div className="md:flex md:flex-row justify-between items-center flex flex-col-reverse gap-x-10 mt-12">
        <div className="md:w-[50%] w-full md:text-start text-center">
          <GsapAnimation>
          <h3 className="text-3xl font-bold Bricolage mt-5 md:mt-0">
            Hi 👋, I am
          ...
          <ArrowButton className="text-blue-500 bg-black hoverable:hover:text-black" spanclassName="bg-blue-600" aclassName="flex justify-center md:justify-start" />
        </div>
